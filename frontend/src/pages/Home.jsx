...
const LoginModal = ({ show, onClose }) => {
  ...
  const handleForgot = (e) => {
    ...
    setForgotResult(
      result ? `Your password is: ${result}` : "Email not found."
    );
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex flex-col items-center">
      ...
      <header className="w-full flex flex-col items-center py-10" id="home">
        ...
        <p className="text-lg text-gray-700 mb-6 max-w-xl text-center">
          Discover the perfect gift for every occasion. Browse our curated
          selection of unique and thoughtful gifts for your loved ones.
        </p>
        <a
      ...
      <section
        id="about"
        className="w-full max-w-3xl bg-white bg-opacity-80 rounded-xl shadow-lg p-8 my-8"
      >
        <h2 className="text-2xl font-bold text-purple-700 mb-2">About Us</h2>
        <p className="text-gray-700">
          Giftify is your one-stop shop for unique, thoughtful gifts for every
          occasion. We believe in making every celebration special with
          handpicked items that bring joy to your loved ones.
        </p>
      </section>
      <section
        id="contact"
        className="w-full max-w-3xl bg-white bg-opacity-80 rounded-xl shadow-lg p-8 mb-8"
      >
        ...
        <form className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="self-end px-6 py-2 bg-pink-500 text-white rounded-full hover:bg-pink-400 transition"
          >
            Send
          </button>
        </form>
